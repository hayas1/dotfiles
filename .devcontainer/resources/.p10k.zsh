# Generated by Powerlevel10k configuration wizard on 2022-09-23 at 02:07 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    devcontainer            # custom devcontainer indicator (https://github.com/devcontainers)
    # load                  # CPU load
  ...
  typeset -g POWERLEVEL9K_MODE=${USE_NERDFONT:-powerline}
